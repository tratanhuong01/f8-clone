        ...
        <div className='home-left'>
            ...
            <ul className='home-left-category'>
                {categories.map(category =>
                    <li onClick={() => setActive(category.id)} key={category.id}
                        className={`home-left-category-item
                        ${active === category.id ? 'home-left-category-active' : ''}`}
                    >
                        {category.svg()}
                        <p>{category.name}</p>
                    </li>
